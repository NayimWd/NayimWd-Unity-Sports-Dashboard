...
const Header: React.FC<HeaderProps> = ({handleToggle}) => {
  return (
    <nav className="w-full  fixed top-0 z-50 overflow-x-hidden bg-sidebar border-b border-b-border opacity-90 shadow ">
        <div className="p-3 md:p-4 lg:p-5 opacity-100">
            <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
                <button className="mr-2 shadow-sm bg-bg dark:shadow-xl xs:mr-3 text-font inline-flex items-center focus:outline focus:outline-sidebar p-2 rounded-lg sm:hidden">
