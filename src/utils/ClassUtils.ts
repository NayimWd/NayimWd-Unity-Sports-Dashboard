export const fontStyle = {
    HeroTitle: "text-4xl lg:text-5xl font-bold font-merriweather font-bold",
    pageTitle: "text-3xl lg:text-4xl font-bold font-inter font-bold",
    ...
    cardTitle: "text-xl lg:text-2xl font-semibold font-inter font-semibold",
