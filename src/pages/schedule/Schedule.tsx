...
const Schedule = () => {
  ...
  const { data, isLoading: sLoading, isFetching } = useGetSchedultQuery({ tournamentId: activeTournamentId },
  ...
  return (
    <PageLayout>
      ...
      <PageHeader
        topTitle="Schedule"
        title={latestTournamentName ? latestTournamentName : "Tournament schedule"}
